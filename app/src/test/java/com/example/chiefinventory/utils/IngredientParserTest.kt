...
class IngredientParserTest {
    ...
    fun `preClean basic trimming and symbol removal`() {
        ...
        assertEquals("100 g", IngredientParser.preClean("  ± 100 g  "))
        assertEquals("200 g", IngredientParser.preClean("200 g +/-"))
        assertEquals("50 g", IngredientParser.preClean("+- 50 g"))
    }
    ...
    fun `preClean keyword  environ  removal`() {
        ...
        assertEquals("100 g", IngredientParser.preClean("environ 100 g"))
        assertEquals("200 g", IngredientParser.preClean("200 g ENVIRON"))
    }
    ...
    fun `preClean OCR  1  correction for special characters`() {
        ...
        assertEquals("1 citron", IngredientParser.preClean("| citron"))
        assertEquals("1 orange", IngredientParser.preClean("I orange"))
        assertEquals("1/2", IngredientParser.preClean("l/2"))
        assertEquals("1 gousse", IngredientParser.preClean("! gousse"))
    }
    ...
    fun `preClean OCR  le  and  l  article correction`() {
        ...
        assertEquals("le citron", IngredientParser.preClean("1 e citron"))
        assertEquals("l'oignon", IngredientParser.preClean("T'oignon"))
        assertEquals("l'ail", IngredientParser.preClean("1'ail"))
    }
    ...
    fun `preClean apostrophe and spacing normalization`() {
        ...
        assertEquals("jaune d'oeuf", IngredientParser.preClean("jauned' euf"))
        assertEquals("jus d'orange", IngredientParser.preClean("jus d' orange"))
    }
    ...
    fun `preClean  oeuf  spelling correction`() {
        ...
        assertEquals("1 oeuf", IngredientParser.preClean("1 euf"))
        assertEquals("2 oeufs", IngredientParser.preClean("2 eufs"))
    }
    ...
    fun `preClean abbreviated unit  c   normalization`() {
        ...
        assertEquals("1 c. à soupe", IngredientParser.preClean("Ic à soupe"))
        assertEquals("1 c. à café", IngredientParser.preClean("!c. à café"))
        assertEquals("c. à soupe", IngredientParser.preClean("c à soupe"))
    }
    ...
    fun `preClean space insertion between digit and letter`() {
        ...
        assertEquals("200 g", IngredientParser.preClean("200g"))
        assertEquals("1 l", IngredientParser.preClean("1l"))
    }
